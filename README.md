...
This is a fork of [@vegardit/nestjs-prisma-generator](https://github.com/vegardit/nestjs-prisma-generator) and adds multiple features:
...
```sh
npm install --save-dev nestjs-prisma-generator
```
...
| `wrapRelationsAsType = "false"`                                  | If `true`, import relations as types to solve circular reference issues with SWC (see [#39](https://github.com/Brakebein/nestjs-prisma-generator/issues/39#issuecomment-2374098494))                                      |
| `showDefaultValues = "false"`                                    | If `true`, makes fields with `@default` attribute visible by default, instead of using `@DtoCreateOptional` and `@DtoUpdateOptional` each time (see [#51](https://github.com/Brakebein/nestjs-prisma-generator/issues/51)) |
...
| `@DtoTypeFullUpdate`                | in the generated `UpdateDTO`, use the `CreateDTO` of the composite type to enforce a complete replacement the old values (see [#2](https://github.com/Brakebein/nestjs-prisma-generator/issues/2#issuecomment-1238855460))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
All files are released under the [Apache License 2.0](https://github.com/Brakebein/nestjs-prisma-generator/blob/master/LICENSE).
