...
export const DTO_INPUT_HIDDEN = /@DtoInputHidden/;
...
export const DTO_EXCLUDE_PLAIN_ONLY = /@DtoExcludePlainOnly/;
export const DTO_CREATE_OPTIONAL = /@DtoCreateOptional/;
export const DTO_INPUT_OPTIONAL = /@DtoInputOptional/;
export const DTO_CREATE_REQUIRED = /@DtoCreateRequired/;
export const DTO_INPUT_REQUIRED = /@DtoInputRequired/;
...
export const DTO_INPUT_VALIDATE_IF = /@DtoInputValidateIf/;
